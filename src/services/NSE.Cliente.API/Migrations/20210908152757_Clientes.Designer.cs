...
namespace NSE.Cliente.API.Migrations
{
    ...
    [Migration("20210908152757_Clientes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NSE.Cliente.API.Models.ClienteLoja", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NSE.Cliente.API.Models.ClienteLoja", b =>
                {
                    b.OwnsOne("NSE.Core.DomainObjects.Cpf", "Cpf", b1 =>
                        {
                            b1.Property<Guid>("ClienteLojaId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ClienteLojaId");

                            b1.ToTable("Clientes");

                            b1.WithOwner()
                                .HasForeignKey("ClienteLojaId");
                        });
            ...
            modelBuilder.Entity("NSE.Cliente.API.Models.Endereco", b =>
                {
                    b.HasOne("NSE.Cliente.API.Models.ClienteLoja", "Cliente")
                        .WithOne("Endereco")
